	...
	async execute(interaction) {
		...
		const serverInfoEmbed3 = new EmbedBuilder()
			...
			.setDescription(
				...
				'## <a:arrow:1364978340120887307> Rule No. 7\n' +
				'- As a community we respect our moderation team for the work they do. Please respect the staff, otherwise we would need to take action accordingly.\n\n' +
